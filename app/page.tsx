...
export default function Home() {
  return (
    <div className="mx-auto flex min-h-screen max-w-2xl flex-col justify-center px-6 py-16">
      <p className="text-sm font-medium text-accent">Higashi-Kyoto alpine</p>
      <h1 className="mt-2 text-4xl font-bold tracking-tight">山行記録</h1>
      ...
      <div className="mt-8 flex gap-4 text-base font-medium">
        <Link
          href="/records"
          className="flex h-12 items-center justify-center rounded-full bg-accent px-6 text-white transition-opacity hover:opacity-90"
        >
          記録一覧を見る
        </Link>
        <Link
